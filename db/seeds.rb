...
Artist.create(name: "Pablo Picasso", bio: "Pablo Ruiz Picasso was a Spanish painter, sculptor, printmaker, ceramicist and theatre designer who spent most of his adult life in France.", contact: "pablo@gmail.com", style: "Cubism", dates: "1881-1973", image: "https://static.stacker.com/s3fs-public/styles/sar_screen_maximum_large/s3/2021-05/Picasso%20Lead%20Color.png", user_name: "Pablo", password: "pablo123")
...
Piece.create(name: "Phone Death", category: "Illustration", style: "Traditional", desc: "A submission for Ink-Tober.", price: 20, date: 2016, image: "https://dn0.newtumbl.com/img/169363/35546872/1/51320361/nT_1aq7ii3f7a47pbn4j9czg45s.jpg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)

Piece.create(name: "The Old Guitarist", category: "Painting", style: "Cubism", desc: "The Old Guitarist is an oil painting by Pablo Picasso, which he created in late 1903 and early 1904. It depicts an elderly musician, a haggard man with threadbare clothing, who is hunched over his guitar while playing in the streets of Barcelona, Spain.", price: 20000, date: 1903, image: "https://i.pinimg.com/564x/10/52/c3/1052c31bf523c6c1ab679df7f68d5a92.jpg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)

Piece.create(name: "Femme au chapeau (Woman with Hat)", category: "Sculpture", style: "Cubism", desc: "Sheet metal, cut out, folded, and painted in 1963", price: 25000, date: 1961/1963, image: "https://d7hftxdivxxvm.cloudfront.net/?resize_to=fit&width=497&height=640&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FoKgx8qKuLF3OPs_XAxbLsA%2Flarge.jpg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)

Piece.create(name: "Mona Lisa", category: "Painting", style: "High Renaissance", desc: "The Mona Lisa is a half-length portrait painting by Italian artist Leonardo da Vinci. Considered an archetypal masterpiece of the Italian Renaissance, it has been described as 'the best known, the most visited, the most written about, the most sung about, the most parodied work of art in the world'.", price: 45000, date: 1503, image: "https://www.artranked.com/images/a9/a9fa4377d916ccd568f855c35e5577d8.jpeg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)

Piece.create(name: "The Persistence of Memory", category: "Painting", style: "Surrealism", desc: "The Persistence of Memory is a 1931 painting by artist Salvador Dalí and one of the most recognizable works of Surrealism. First shown at the Julien Levy Gallery in 1932, since 1934 the painting has been in the collection of the Museum of Modern Art in New York City, which received it from an anonymous donor", price: 45000, date: 1931, image: "https://cdn.britannica.com/10/182610-050-77811599/The-Persistence-of-Memory-canvas-collection-Salvador-1931.jpg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)

Piece.create(name: "Ram's Head, White Hollyhock-Hills", category: "Painting", style: "Modernism", desc: "Georgia O'Keeffe's Ram's Head, White Hollyhock-Hills can be counted among her most important paintings. In it, the whitened bones of a ram's skull float weightlessly against the brooding New Mexico skies and a pristine white hollyhock blossom hovers beside it, the Rio Grande Valley hills below.", price: 40000, date: 1935, image: "https://images.fineartamerica.com/images/artworkimages/mediumlarge/2/rams-head-white-hollyhock-hills-georgia-okeeffe.jpg", gallery_id: Gallery.all.sample.id, artist_id: Artist.all.sample.id)
